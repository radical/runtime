        ...
        public async Task InspectNullableLocals(string method_name, bool is_async) => await CheckInspectLocalsAtBreakpointSite(
            ...
            wait_for_event_fn: async (pause_location) =>
            {
                ...
                await CheckProps(locals, new
                {
                    ...
                    o_n_i       = TNumber(5),
                    o_n_i_null  = TObject("object", is_null: true),

                    n_dt        = TDateTime(dt),
                    n_dt_null   = TObject("System.Nullable<System.DateTime>", null),
                    o_n_dt      = TDateTime(dt),
                    o_n_dt_null = TObject("object", null),
                    ...
                    o_n_gs_null = TObject("object", null),
                ...
                foreach (var name in new[] { "n_gs", "o_n_gs" })
                {
                ...
                var o_n_ia_props = await GetObjectOnLocals(locals, "o_n_ia");
                await CheckProps(o_n_ia_props, new[]
                {
                    TNumber(123),
                    TNumber(671)
                }, nameof(o_n_ia_props));
